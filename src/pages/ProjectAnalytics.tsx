    ...
    <div className="bg-white text-black p-6 rounded-lg w-2/3 max-w-3xl shadow-2xl overflow-y-auto max-h-[85vh]">
      ...
      <div>
        ...
        <div className='flex justify-start items-center'>
          ...
          <h2 className=' px-2 text-xl'>{props.sentiment_cal_pol}</h2>
        </div>
        <div className='flex justify-start items-center'>
        ...
        <div className='flex justify-start items-center'>
          ...
          <h2 className=' px-2 text-xl'>{props.depr_rout.split(',')[0]} | {props.depr_rout.split(',')[1]} | {props.depr_rout.split(',')[2]}</h2>
        </div>
        <div className='flex justify-start items-center'>
          <h1 className='font-extrabold text-2xl px-2 min-w-[150px]'>Level0 Scrutiny:</h1>
          <h2 className=' px-2 text-xl'>{props.lo_sc}</h2>
        </div>
      </div>
