...
import 'ag-grid-community/styles/ag-grid.css';
import 'ag-grid-community/styles/ag-theme-alpine.css';
import { useGetWtcsReportQuery } from '../features/wtcreportApi';
...
const ReportAnalytics = () => {
  const { data, error, isLoading } = useGetWtcsReportQuery
  const [isModalOpen, setIsModalOpen] = useState(false);
  ...
  const handleFilter = () => {
    ...
    const filtered = (data || []).filter((item: RowData) => {
  ...
  const columnDefs = useMemo(() => [
    ...
    { headerName: 'Level 0 Scrutiny', field: 'lo_sc', sortable: true },
    { headerName: 'Add Scrutiny', field :'lo_sc_hu', sortable: true},
    { headerName: 'Sentiment Polarity', field: 'sentiment_cal_pol', sortable: true },
  ...
  return (
    <div className="flex flex-col bg-[#24303F] text-white">
      <div className="p-4">
        <div className="flex space-x-4 mb-4">
          <div>
            <label htmlFor="fromDate" className="block text-sm">From:</label>
            <input
              type="date"
              id="fromDate"
              value={fromDate}
          ...
          <div>
            <label htmlFor="toDate" className="block text-sm">To:</label>
            <input
              type="date"
              id="toDate"
              value={toDate}
          ...
          <button
            ...
            className="bg-gray-500 py-2 px-4 rounded hover:bg-gray-700"
          >
            Clear
          </button>
          <button
