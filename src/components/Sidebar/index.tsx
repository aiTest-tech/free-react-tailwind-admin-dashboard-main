...
import { FaAngleUp, FaMicrophone } from "react-icons/fa";
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <li className='flex justify-between items-center bg-graydark rounded-lg px-2' onClick={() => setisprojectdown(!isprojectdown)}>
                <NavLink
                  to="/dashboard"
                ...
                {
                  isprojectdown ? <FaAngleDown /> : <FaAngleUp />
                }
              ...
              <li>
                <NavLink
                  to="/activity"
                  className={`group relative flex items-center gap-2.5 rounded-xl py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('activity') &&
