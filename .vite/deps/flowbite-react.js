...
function FloatingFocusManager(props) {
  ...
  index(() => {
    if (disabled || !isHTMLElement(floatingFocusNode))
      return;
    const doc = getDocument(floatingFocusNode);
...
var DatepickerRender = ({
  ...
  const effectiveDefaultView = (0, import_react26.useMemo)(() => {
  ...
  const [selectedDate, setSelectedDate] = (0, import_react26.useState)(value ?? initialDate);
  const [viewDate, setViewDate] = (0, import_react26.useState)(value ?? effectiveDefaultView);
